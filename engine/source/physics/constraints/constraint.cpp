...
Constraint::Constraint(Object* object1, Object* object2, const bool& constrainGreaterThanZero)
	: object1_(object1), object2_(object2), bias_(0), constrainGreaterThanZero_(constrainGreaterThanZero) {
...
bool Constraint::calcConstraint(){
	...
	return constraint_ == 0 || (constrainGreaterThanZero_ && constraint_ > 0);
}
...
void Constraint::apply(){
	...
	if(object1_->getPhysicsType() == PHYS_DYNAMIC){
	...
	if(object2_->getPhysicsType() == PHYS_DYNAMIC){
